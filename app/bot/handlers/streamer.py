...
async def generate_stream_response(client: Client, media_msg: Message, target_reply: Message):
    ...
    text = (
        ...
        f"📱 **{to_smallcaps('ᴍᴏʙɪʟᴇ ᴀᴘᴘs')}** : {to_smallcaps('ᴏᴘᴇɴ ᴛʜᴇ ᴡᴀᴛᴄʜ ʟɪɴᴋ ᴛᴏ ʟᴀᴜɴᴄʜ ᴍx ᴘʟᴀʏᴇʀ, ᴠʟᴄ, ᴘʟᴀʏɪᴛ ᴏʀ ᴋᴍᴘʟᴀʏᴇʀ ɪɴsᴛᴀɴᴛʟʏ!')}"
        f"{format_watermark()}"
    )
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(f"🌐 {to_smallcaps('ᴡᴇʙ ᴘʟᴀʏᴇʀ & ᴀᴘᴘ ɪɴᴛᴇɴᴛs')}", url=watch_url)
        ],
        [
